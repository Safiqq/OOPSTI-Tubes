...
public class CLIMain extends Main {
    ...
    public void start() {
        String art = "             ________  ___  _____ ______   ________  ___       ___  ________  ___  _________    ___    ___ \n" +
        ...
        while (isStarted) {
            ...
            if (equals(menu, "HELP")) {
                ...
                if (equals(act, "WORK")) {
                    ...
                    if (Sim.getListSim().size() == 1) {
                        System.out.println("Tidak ada rumah Sim lain yang tersedia.");
                        System.out.println("Rumah Sim " + currentSim.getFullName() + " adalah rumah satu-satunya di World.");
                    } else {
                        ...
                        System.out.println("Mengunjungi rumah " + ownerHouse + "...");
                        System.out.println("Lokasi rumah di World: (" + houseLoc.getX() + ", " + houseLoc.getY() + ")");
                    ...
                    if (equals(currentSim.getObjLoc(), "Cermin")) {
                        ...
                        System.out.println("Now playing: Cupid - Twin Version");
                        System.out.println("Sim joget di depan cermin!");
    ...
    public void installItem() {
        ...
        if (equals(currentSim.getFullName(), currentSim.getSimLoc().getHouse().getOwner())) {
            ...
            if (boxNonFood.getList().size() > 0) {
                                    ...
                                    if (startX >= 0 && startX <= 5 && startY >= 0 && startY <= 5) {
                                        ...
                                        if (endX <= 5 && endY <= 5) {
                                            ...
                                            if (targetRoom.isSpaceEmpty(startPoint, endPoint)) {
                                                ...
                                                System.out.println("Barang berhasil dipasang di " + targetRoom.getRoomName() + ".");
                                                pointValid = true;
                                            } else {
                ...
                System.out.println("Anda tidak memiliki barang di inventory.");
            }
        } else {
