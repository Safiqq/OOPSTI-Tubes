...
// nf1 = new NonFood("Kasur",2,1,1000000,new Action("Ditiduri","Ya
// ditiduri"),new Point(0,0), new Point(2,2));
// }
//
// @Test
...
// assertEquals(2,nf1.getLength());
// assertEquals(1,nf1.getWidth());
// assertEquals(1000000,nf1.getPrice());
//
...
// nf1.setLength(4);
// nf1.setWidth(3);
// nf1.setPrice(2000000);
// nf1.setAction(new Action("Ditendang","Ya Ditendang"));
// nf1.setStartPoint(new Point(5,5));
// nf1.setEndPoint(new Point(3,3));
// assertEquals(4,nf1.getLength());
// assertEquals(3,nf1.getWidth());
// assertEquals(2000000,nf1.getPrice());
